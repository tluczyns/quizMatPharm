...
<content>
	...
	<start isSection="1" labelBtnGoToQuiz="Rozpocznij" title="Bezpiecznie w podróży">
...
<bd>Niepasujące elementy</bd>: plecak, szalik.]]></bad>
			...
			<activity type="selectAnswers">
				<question suffNameClass="imgQuestion4">
					<value>Wraz z klasą wybrałeś się na pieszą wycieczką do podmiejskiego lasu, aby urządzić piknik. Idziecie w dużej zorganizowanej grupie. Jak bezpiecznie poruszać się po drodze w takiej sytuacji? Wybierz poprawną odpowiedź.</value>
				</question>
				<btn isCorrect="1">
			...
			<activity type="connectDots">
				<settings nameDimension="width" valueDimensionA="150" valueDimensionB="250" isAddMargin="1" distanceOrderBetweenBtns="15" distanceBetweenTypesBtnDot="110" posYBtnCheck="545" />
				<question suffNameClass="imgQuestion56">
					<value>Podczas podróży możesz stać się ofiarą lub świadkiem wypadku. Trzeba wtedy wezwać odpowiednie służby. Połącz numer telefonu z właściwą służbą ratunkową.</value>
				</question>
				<btn name="a0" numProperBtnOtherType="2">
					<value>997</value>
				</btn>
				<btn name="a1" numProperBtnOtherType="0">
					<value>998</value>
				</btn>
				<btn name="a2" numProperBtnOtherType="1">
					<value>999</value>
				</btn>
				<btn name="b0" suffNameClass="imgBtnDot5b0" />
				<btn name="b1" suffNameClass="imgBtnDot5b1" />
				<btn name="b2" suffNameClass="imgBtnDot5b2" />
				<feedback>
